...
urlpatterns = patterns('',
    ...
    url(r'^relationlist/$', UserRelationTopicList.as_view(), name='relation_list'),
    url(r'^bestlist/$', TopicBestList.as_view(), name='best_list'),
    url(r'^search/$', SearchContentList.as_view(), name='topic_search'),
